...
type TimePoints struct {
	...
	VehicleHeading int32 `json:"VehicleHeading,omitempty"`

	VehicleLatitude string `json:"VehicleLatitude,omitempty"`

	VehicleLongitude string `json:"VehicleLongitude,omitempty"`
}
