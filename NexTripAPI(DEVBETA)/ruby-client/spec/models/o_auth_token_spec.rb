...
# Unit tests for SwaggerClient::OAuthToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OAuthToken' do
  before do
    # run before each test
    @instance = SwaggerClient::OAuthToken.new
  end
  ...
  describe 'test an instance of OAuthToken' do
    it 'should create an instance of OAuthToken' do
      expect(@instance).to be_instance_of(SwaggerClient::OAuthToken)
    end
  end
