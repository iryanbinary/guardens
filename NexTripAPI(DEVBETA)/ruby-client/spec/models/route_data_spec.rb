...
# Unit tests for SwaggerClient::RouteData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RouteData' do
  before do
    # run before each test
    @instance = SwaggerClient::RouteData.new
  end
  ...
  describe 'test an instance of RouteData' do
    it 'should create an instance of RouteData' do
      expect(@instance).to be_instance_of(SwaggerClient::RouteData)
    end
  end
