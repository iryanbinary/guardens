...
# Unit tests for SwaggerClient::BusRouteInfoApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BusRouteInfoApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BusRouteInfoApi.new
  end
  ...
  describe 'test an instance of BusRouteInfoApi' do
    it 'should create an instance of BusRouteInfoApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BusRouteInfoApi)
    end
  end

  # unit tests for updateroute
  # 
  # Update a bus route
  # @param route Sepcify the Route ID as an integer.
  # @param [Hash] opts the optional parameters
  # @return [RouteData]
  describe 'updateroute test' do
    it "should work" do
